...
import S from "./UserMap.module.scss"
...
import {CanvasStatMap} from "../../components/canvasStatMap/canvasStatMap";
    ...
    return (
        <>
            ...
            <motion.div
                ...
                <Button href={"./presentation28_03.pptx"} download={"./presentation28_03.pptx"} color={"primary"}
                        variant={"contained"}><ArrowDownward/>Скачать презентацию</Button>
            </motion.div>
        </>
    )
}